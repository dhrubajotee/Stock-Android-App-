...
public class Purchase extends AppCompatActivity {
    ...
    DatabaseReference databaseDebit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemId = (EditText) findViewById(R.id.editId);
        ...
        databaseDebit = FirebaseDatabase.getInstance().getReference("debit");
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseItems.child(itemId.getText().toString()).child("balance").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        int newBalance= balance+Integer.parseInt(quantity.getText().toString());
                        databaseItems.child(itemId.getText().toString()).child("balance").setValue(Integer.toString(newBalance));
                            ...
                            DatabaseReference databaseReference=databaseDebit.push();
                            ...
                            databaseReference.child("Debit").setValue(quantity.getText().toString());
                            databaseReference.child("Credit").setValue("0");
